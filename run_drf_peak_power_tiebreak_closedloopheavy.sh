...
for TRIAL in 1 2 3; do
  echo "=== DRFPEAKPOWERTIEBREAKCLOSEDLOOPHEAVY BATCH: policy=$OUTNAME trial=$TRIAL ==="
  ...
  pkill -f "power_logger.py" 2>/dev/null
  sleep 3
  echo "=== DRFPEAKPOWERTIEBREAKCLOSEDLOOPHEAVY BATCH: policy=$OUTNAME trial=$TRIAL COMPLETE ==="
done
echo "=== FULL DRFPEAKPOWERTIEBREAKCLOSEDLOOPHEAVY BATCH COMPLETE ==="
