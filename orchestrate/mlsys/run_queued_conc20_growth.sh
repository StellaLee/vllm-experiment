...
env GPU=0 TAG=convdiverse_conc20_widened_gpu0 CONC=20 WHALE_MIN=18000 BUDGETS='16384 512' TRIALS="$TRIALS_11_100" PORT=8073 ./orchestrate/pesim/orchestrate_pesim_gate.sh >> $LOG 2>&1
