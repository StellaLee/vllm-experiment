...
# Same phase-schedule workload as every other lgate arm. Re-analyzes all 10 arms into
...
log "re-analyzing all 10 arms"
SCHEDULE="$SCHED" \
  ARMS="16384 512 2048 lengthgate 16384lpt512 16384lpt256 16384lpt2048 2048lpt512 adaptivelpt ${ARM}" \
