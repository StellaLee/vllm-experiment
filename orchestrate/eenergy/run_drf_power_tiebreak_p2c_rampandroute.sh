...
for TRIAL in 1 2 3; do
  echo "=== DRFPOWERTIEBREAKP2CRAMPANDROUTE BATCH: policy=$OUTNAME trial=$TRIAL ==="
  ...
  pkill -f "power_logger.py" 2>/dev/null
  sleep 3
  echo "=== DRFPOWERTIEBREAKP2CRAMPANDROUTE BATCH: policy=$OUTNAME trial=$TRIAL COMPLETE ==="
done
echo "=== FULL DRFPOWERTIEBREAKP2CRAMPANDROUTE BATCH COMPLETE ==="
