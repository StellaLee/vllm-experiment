#!/bin/bash
# Extends drf_no_power and lmetric (validated so far only on Heavy/Closed-Loop's long
# condition, where drf_no_power cleanly dominated drf_fixed) to the remaining 6 conditions:
# BurstGPT, Heavy/Matched, Light/Cachehit, Heavy/Closed-Loop (short), Ramp & Route, WildChat.
# Same structure/helpers as run_pergpu_coincidence_ceiling_6conditions.sh; harness args
...
ARMS=("drf_no_power drf_no_power" "lmetric lmetric")
...
echo "=== NO_POWER 6-CONDITION BATCH COMPLETE ==="
