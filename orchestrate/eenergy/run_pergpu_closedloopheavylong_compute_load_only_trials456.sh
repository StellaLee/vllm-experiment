#!/bin/bash
# Extends compute_only/load_only from 3 trials to 6, to verify whether the surprising
# p99_ramp tie (1059.7 for both, exactly, at n=3) and the "single resource beats their max()
# combination" finding (both beat drf_no_power's p99_ramp of 1198.5) is robust or a 3-trial
# coincidence. Same condition/params as
...
echo "=== CLOSEDLOOPHEAVYLONG COMPUTE_LOAD_ONLY TRIALS 4-6 BATCH COMPLETE ==="
