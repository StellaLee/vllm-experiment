#!/bin/bash
# Extends Heavy/Matched rate=7.0 and rate=15.0 from n=3 to n=6 for coincidence_ceiling and
# round_robin (trials 4-6 only), matching the rigor of the original rate=10.7 point
# (findings.md Part 19) -- especially important for confirming the surprising rate=15.0
# "effect vanishes under saturation" finding (Part 20) isn't a small-n artifact.
set -x
...
echo "=== MATCHED_RATE_SWEEP_N6 BATCH COMPLETE ==="
