...
Usage:
    python scripts/pesim/gen_overview_real_data.py --out scripts/pesim/overview_real_data.npz
"""
import argparse
import sys
...
def main():
    ...
    ap.add_argument("--out", default="/Users/li/Documents/vllm-experiment/scripts/pesim/overview_real_data.npz")
