...
Usage:
    python scripts/pesim/gen_overview_real_data.py --out scripts/pesim/overview_real_data.npz   # once
    python scripts/pesim/plot_paper_overview_schematic.py --data scripts/pesim/overview_real_data.npz \
...
def main():
    ...
    ap.add_argument("--data", default="scripts/pesim/overview_real_data.npz")
