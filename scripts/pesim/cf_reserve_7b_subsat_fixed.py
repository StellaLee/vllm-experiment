#!/usr/bin/env python3
"""Re-derivation of cf_reserve_7b_subsat.py using fit_kappa_self_consistent instead of a fixed
50s warmup -- companion check to cf_reserve_tp2_14b_fixed.py. 7B sub-saturated kappas were
borderline (tau ~8.4-10.5s, 5*tau ~42-52s, right at the old 50s cutoff), so this checks whether
the warmup-insufficiency artifact meaningfully moved these numbers too.
"""
import sys
...
MONO_TRIALS = [
    ("2026-07-30-pesim_gate_wide_subsat-b16384-t1", 47.05),
    ("2026-07-30-pesim_gate_wide_subsat-b16384-t2", 41.61),
    ("2026-07-30-pesim_gate_wide_subsat-b16384-t3", 43.94),
]
CHUNK_TRIALS = [
    ("2026-07-30-pesim_gate_wide_subsat-b512-t1", 44.97),
    ("2026-07-30-pesim_gate_wide_subsat-b512-t2", 40.47),
    ("2026-07-30-pesim_gate_wide_subsat-b512-t3", 41.21),
]
WHALE_THRESH = 15000
...
def main():
    ...
    print()
    print("=== 7B sub-saturated (FIXED: self-consistent kappa/warmup): mean +/- std across 3 trials ===")
