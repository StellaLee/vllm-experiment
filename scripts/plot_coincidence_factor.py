...
"""Generate the two coincidence-factor figures for paper.md/main.tex Sec 6:
  ...
  2. fig_cf_ramp.png: (a) ramp-rate CF vs N at s=0 for mono/chunk=512 tau, showing the
     fleet-scale attenuation saturating rather than compounding; (b) ramp-rate CF vs s at
     N=200, contrasted with the level metric's threshold to show it rises smoothly instead.
...
def fig_ramp(cal, out):
    ...
    ax.set_title("(a) saturates, doesn't vanish", fontsize=10)
