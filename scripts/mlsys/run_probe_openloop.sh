...
#
# Usage:
#   bash scripts/mlsys/run_probe_openloop.sh                 # rate=3, trial=1
#   RATE=3 TRIAL=2 bash scripts/mlsys/run_probe_openloop.sh
#
set -euo pipefail
cd "$(dirname "$0")/.."
...
$PYTHON scripts/mlsys/hotpatch_slo_chunk.py
