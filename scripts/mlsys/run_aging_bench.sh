...
#
# Usage:
#   bash scripts/mlsys/run_aging_bench.sh                          # aging disabled (T=inf)
#   AGING_THRESHOLD_MS=2000 bash scripts/mlsys/run_aging_bench.sh  # 2s threshold
#   RESULT_TAG=aging_2s_r8_burstgpt AGING_THRESHOLD_MS=2000 bash scripts/mlsys/run_aging_bench.sh
