...
#
# Usage:
#   env RATE_BURSTGPT=3 bash scripts/mlsys/run_near_sat_bench.sh
#   env RATE_BURSTGPT=3 TRIAL=1 bash scripts/mlsys/run_near_sat_bench.sh  # repeated trial
#   env RATE_BURSTGPT=3 NUM_PROMPTS=500 bash scripts/mlsys/run_near_sat_bench.sh
#   env AGING_THRESHOLD_MS=5000 bash scripts/mlsys/run_near_sat_bench.sh
#
