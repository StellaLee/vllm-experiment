...
env MODEL=/data/pli/models/Qwen1.5-MoE-A2.7B-Chat GPUS=0,1 TAG=moe_wide CONC=4 WHALE_MIN=18000 BUDGETS='16384 512' TRIALS='1 2 3' PORT=8073 ./orchestrate_pesim_gate_tp2.sh >> $LOG 2>&1
