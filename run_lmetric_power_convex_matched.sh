#!/bin/bash
# Test lmetric_power_convex on the token-throughput-matched whale-injection workload (moderate-heavy
...
OUTNAME=lmetric_power_convex
POLICY=lmetric_power_convex
